...
${$('input[name="briefs_debriefs"]:checked').val()} Briefs and Debriefs[color=red]*[/color]
${$('input[name="clearing_incidents"]:checked').val()} Clearing Outstanding Incidents[color=red]*[/color]
${$('input[name="non_supervisory_work"]:checked').val()} Non-supervisory Police Work[color=red]*[/color]
${$('input[name="role_of_supervisor"]:checked').val()} Role of a Supervisor[/size][/td]
...
${$('input[name="contperm_setup"]:checked').val()} Containment & Perimeter Setup[color=red]*[/color]
${$('input[name="evidence_logging"]:checked').val()} Evidence Logging[/size][/td]
